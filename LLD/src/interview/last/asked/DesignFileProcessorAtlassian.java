...
public class DesignFileProcessorAtlassian {
	    ...
	    public static void main(String[] args) {
	    	DesignFileProcessorAtlassian processor = new DesignFileProcessorAtlassian();
